        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Avenger's Console!</span></a>
            </div>
        ...
        <input type="hidden" name="user" value="${uname}"/>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <c:forEach var="EmployeeDetails" items="${Em}">
                <h3>
                <c:out value="${EmployeeDetails.jobTitle}"/>
         
                </h3>
                       
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Console </a></li>
                  <li><a href="form_validation.html"><i class="fa fa-edit"></i> Employee  Form </a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">${EmployeeDetails.username}
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count green">${totalemp}</div>
              <span class="count_bottom"><i class="green">  </span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Total Females</span>
              <div class="count green">123.5000</div>
              <span class="count_bottom"><i class="green"> </span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count green">${totalprod}</div>
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i> </p>
                            </td>
                            <td>20%</td>
                          </tr>
                          <tr>
                    ...
                    <div class="x_content">
                      ...
                      <div class="">
                        <ul class="to_do">
                          ...
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> Create email address for new employee</p>
                          </li>
                          <li>
                            <p>
                         ...
                         <li>
                            <p>
                              <input type="checkbox" class="flat"> Attend conference tomorrow</p>
                          </li>
                        </ul>
                      </div>
                    </div>
